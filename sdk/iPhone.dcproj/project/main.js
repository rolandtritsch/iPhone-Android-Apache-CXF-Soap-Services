...
function Services() {
  var _strBaseUrl = 'http://rolandsmac.local:9000';
  ...
  this.getGreeterService = function()  {
    if(_objTheGreeterService == null) {
      ...
      _objTheGreeterService.url = _strBaseUrl + '/SimpleService';
    }
  ...
  this.getBeverageService = function() {
    if(_objTheBeverageService == null) {
      ...
      _objTheBeverageService.url = _strBaseUrl + '/BeverageService';
    }
  ...
  this.getBankService = function() {
    if(_objTheBankService == null) {
      ...
      _objTheBankService.url = _strBaseUrl + '/BankService';
    }
...
var gstrCustomerServiceUrl = 'http://rolandsmac.local:9000/CustomerService';
